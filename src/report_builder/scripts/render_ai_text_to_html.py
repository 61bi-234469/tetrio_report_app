...
def build_context(text: dict, report_data: dict) -> dict:
    ...
    return {
        ...
        "strengths": normalize_regular(text.get("strengths", {})),
        "weaknesses": normalize_regular(text.get("weaknesses", {})),
        "style": normalize_regular(text.get("style", {})),
        "round_states": normalize_regular(text.get("round_states", {})),
        "streak": normalize_regular(text.get("streak", {})),
        "session": normalize_regular(text.get("session", {})),
        "replays": {
            "key": text_or_dash(text.get("replays", {}).get("key")),
            "rows": text.get("replays", {}).get("rows", []) or [],
            "summary": text_or_dash(text.get("replays", {}).get("summary")),
        },
        "summary": {
